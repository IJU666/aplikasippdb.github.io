  ...
  <body>
    <nav class="navbar navbar-expand-lg mb-4 p-0  " style="background-color: #2070ad;  ">
      <div class="container-fluid ">
        ...
        <a class="nav-link navnaw2 text-light"aria-current="page" href="/datasiswa">Data Calon Siswa</a>
         <li class="nav-item dropdown navnaw2 lebar ">
          <a class="nav-link dropdown-toggle text-light ms-2 me-2 p-0 text-center " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Hasil Seleksi
          </a>
        ...
        <a class="nav-link navnaw text-light" href="/aturjadwal">Jadwal</a>
        <li class="nav-item dropdown navnaw2 lebar ">
...
<div class="col-sm-10 col-md-11 col-lg-11 rounded-3 mx-auto py-4 mt-5 bg-light">
  <div class="float-end col-lg-5">
    <form name="myform" action="checkboxes.asp" method="post" class="row g-4">
      <div class="col-lg-4">
      <input type="button" name="Check_All" class="btn buttonoutline mb-3 float-end py-1" value="Pilih Semua"
  ...
  <div class="col-lg-5 mx-auto">
    <table class="table table-striped rounded-3 text-center shadow">
      ...
      <tr>
        ...
        <td>Aldi Andrian</td>
        <td>
          <input type="checkbox" class="form-check-input mt-0" name="check_list" value="1" >
        </td>
      </tr>

      <tr>
        <td>2</td>
        <td>Fauzan Zianul Haq</td>
        <td>
          <input type="checkbox" class="form-check-input mt-0" name="check_list" value="2" >
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input type="checkbox" class="form-check-input mt-0" name="check_list" value="3" >
        </td>
      </tr>

      <tr>
        <td>4</td>
        <td>Ikhlas Nawaalullah</td>
        <td>
          <input type="checkbox" class="form-check-input mt-0" name="check_list" value="4" >
        </td>
      </tr>
    </form>
            </table>
            ...
            <div class="col-lg-12 mb-5">
              <button type="submit" class="btn button1 float-end py-1 ">Simpan</button>
            </div>
          </div>
        </div>
...
<small><i class="fa-solid fa-copyright"></i> Copyright. All rights reserved</small>
    ...
    <SCRIPT LANGUAGE="JavaScript">
      function Check(chk)
      {
      if(document.myform.Check_All.value=="Pilih Semua"){
      for (i = 0; i < chk.length; i++)
      chk[i].checked = true ;
      document.myform.Check_All.value="Batal";
      }else{
      
      for (i = 0; i < chk.length; i++)
      chk[i].checked = false ;
      document.myform.Check_All.value="Pilih Semua";
      }
      }
      </script>
