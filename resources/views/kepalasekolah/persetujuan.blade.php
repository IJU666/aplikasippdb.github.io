        ...
        {{-- <a class="nav-link navnaw text-light col-lg-6"aria-current="page" href="/datasiswa">Persetujuan Hasil Seleksi</a> --}}
         <li class="nav-item dropdown navnaw col-lg-5 ">
          ...
          <ul class="dropdown-menu mt-2">
            <li><a class="dropdown-item" style="background-color: #e0e0e0;" href="/kepsek">Administrasi</a></li>
  ...
  <div class="col-lg-12">
    <form method="" action="" class="row g-3 ms-5">  
      ...
      <div class="col-lg-4 ms-5">
        <button type="submit" class=" btn button1 mx-1 float-end px-3 py-1">Setujui</button>
        <button type="submit" class=" btn btn-outline-danger float-end px-3 py-1 me-1">Tolak</button>
      </div>
    </form>
  </div>
