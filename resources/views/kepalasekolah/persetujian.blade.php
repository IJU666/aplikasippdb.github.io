    ...
    <nav class="navbar navbar-expand-lg mb-4 p-0  " style="background-color: #2070ad;  ">
      <div class="container-fluid ">
        ...
        {{-- <a class="nav-link navnaw text-light col-lg-6"aria-current="page" href="/datasiswa">Persetujuan Hasil Seleksi</a> --}}
         <li class="nav-item dropdown navnaw col-lg-5 ">
          ...
          <ul class="dropdown-menu mt-2">
            ...
            <li><a class="dropdown-item" style="background-color: #e0e0e0;"  href="/persetujuanujian">Ujian</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown navnaw2 lebar col-lg-3">
          ...
          <ul class="dropdown-menu mt-2">
            <li><a class="dropdown-item" href="laporanadminkepsek">Administrasi</a></li>
  ...
  <div class="col-lg-10 mx-auto">
    <form method="" action="" class="row g-3 ms-5">  
      ...
      <div class="col-lg-4 ms-3">
        <button type="submit" class="btn button1 mx-1 float-end">Setujui</button>
        <button type="submit" class="btn btn-outline-danger float-end">Tolak</button>
      </div>
    </form>
  </div>
  <div class="col-lg-9 mx-auto">
    <table class="table table-striped rounded-3 text-center shadow">
      ...
      <div class="mx-5">
        ...
        <td class="text-danger">BELUM DISETUJUI{{-- backend --}}</td> 
        </tr>
        </div>
          </div>
          </div>
                ...
                <tr>
                  ...
                  <td>LENGKAP{{-- backend --}}</td>
                       <!-- Button trigger modal -->
                  <td class="text-success">LENGKAP{{-- backend --}}</td> 
                  </tr>
                  </div>
                    </div>
                    </div>
