            ...
            <div class="pb-5">
              ...
              <div class="d-flex">
               ...
               <div class="col-sm-5 mx-auto">
                ...
                <label for="email" class=" col-sm-1 px-2"><i class="fa-solid fa-envelope text-secondary fs-3" ></i></label>
              </div>
              ...
              <div class=" col-sm-10 ms-2">
                ...
                <div class="col-sm-8 mt-4 mx-auto text-center" style="opacity: 99%;">
                  <small class="text-secondary">Belum punya akun? <a href="/daftar"style="text-decoration:none;">Daftar Sekarang</a></small>
                </div>
