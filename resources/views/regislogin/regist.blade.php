       ...
       <div class="col-sm-12 my-3 pb-1 pt-4 " style="opacity: 99%;">
                  ...
                  <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="1800">
                        <img src="img/daftar1.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item" data-bs-interval="1800">
                        <img src="img/daftar2.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item" data-bs-interval="1800">
                        <img src="img/daftar3.png" class="d-block w-100" alt="...">
                      </div>
                    </div>
        ...
        <div class="col-md-4">
          ...
          @endif
                ...
                <div><h6 class="text-center fw-semibold fs-2">Daftar</h6></div>
                
                 {{-- username --}}
                <div class="d-flex col-sm-10  mt-4 mx-auto border-bottom" style="opacity: 99%;">
                  <div class="my-auto border-end">
                <label for="email" class=" col-sm-1 text-secondary px-2"><i class="fa-solid fa-envelope fs-3" ></i></label>
              </div>
              <div class=" col-sm-10 ms-2">
                <input type="email" name="email" required value="{{ old('email') }}" autofocus class="form-control-plaintext @error('email') is-invalid @enderror" placeholder="Masukan E-Mail" style="border: none;">  
                @error('email')
                ...
                <div class="d-flex col-sm-10 mt-3 mx-auto border-bottom" style="opacity: 99%;">
                  <div class="my-auto border-end">
                <label for="pass" class=" col-sm-1 text-secondary px-2"><i class="fa-solid fa-lock fs-3" style="margin-left: 3px;"></i></label>
              </div>
              <div class=" col-sm-10 ms-2">
                <input type="password" name="password" id="pass" required class="form-control-plaintext @error('password') is-invalid @enderror" placeholder="Masukan Kata Sandi" style="border: none;">  
                @error('password')
                      <div class="d-flex invalid-feedback">
                        {{ $message }}
                      </div>
              ...
              <div class=" col-sm-10 ms-2">
                <input type="password" name="password_confirmation" id="pass" required class="form-control-plaintext" placeholder="Masukan Ulang Kata Sandi" style="border: none;">  
              </div>
                </div>
                <div class="d-flex mt-4 col-sm-10 mx-auto">
              </div>
                <div class="col-sm-8 mt-2 mx-auto" style=" opacity: 99%;">
                  <button class="buttonoutline btn mt-2 form-control" type="submit"  onclick="confirm ('Apakah Anda Yakin Ingin Menyimpan Data ini?')">Daftar</button>
                </div>
                <div class="col-sm-8 mt-4 mx-auto text-center" style="opacity: 99%;">
                  <small class="text-secondary">Sudah punya akun? <a href="/masuk"style="text-decoration:none;">Masuk</a></small>
                </div>
