...
<div class="col-11 pt-3" >
  <nav>
    <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
      <a href="#"  style="text-decoration: none;"><button class="nav-link col-auto active" >Biodata siswa</button></a>
  ...
  <div class=" tab-content col-lg-12" id="nav-tabContent">
    ...
    <div class="tab-pane fade ms-4 col-12 show active" id="nav-biodata" role="tabpanel" aria-labelledby="nav-biodata-tab">        
      <form action="/isidata" method="post">
        @csrf
            <div class="my-4 border-bottom">
                <div class="mb-3 row">
                    <label for="nisn" class="col-lg-3 col-md-6 col-form-label">NISN</label>
                    <div class="col-lg-6 col-md-10">
                      <input type="number" name="nisn" required value="{{ old('nisn') }}" autofocus  id="nisn" placeholder="Masukan NISN" class="form-control col-lg-9" >
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="nama" class="col-lg-3 col-md-5 col-form-label">Nama Lengkap</label>
                    <div class="col-lg-6 col-md-10 text-center">
                      <input type="text" class="form-control" id="nama" name="nama" required value="{{ old('nama') }}"   placeholder="Masukan Nama Lengkap">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="lahir" class="col-lg-3 col-md-4 col-form-label">Tempat Lahir</label>
                    <div class="col-lg-5 col-md-9 ">
                      <input type="text" class="form-control" id="lahir" name="tempat_lahir" required value="{{ old('tempat_lahir') }}"   placeholder="Masukan Tempat Lahir">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="tanggal" class="col-lg-3 col-md-6 col-form-label">Tanggal Lahir</label>
                    <div class="col-lg-3 col-md-7">
                      <input type="date" class="form-control" id="tanggal" name="ttg" required value="{{ old('ttg') }}"   placeholder="">
                    </div>
                  </div>
                  <div class="mb-3 row ">
                    ...
                    <div class="col-auto form-check mt-1">
                      <input class="form-check-input" type="radio" name="jk" required value="Perempuan" id="flexRadioDefault2" checked>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-lg-3">
                      <input type="text" class="form-control" id="agama" name="agama" required value="{{ old('agama') }}"   placeholder="Masukan Agama">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-lg-4">
                      <div class="input-group">
                        <input type="number" class="form-control" id="hp" name="hp" required value="{{ old('hp') }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}" value="+62"  aria-label="Username" aria-describedby="basic-addon1" placeholder="Contoh (+62 - 898 - 2323 - 3231)">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" name="alamat" id="alamat" required placeholder="Masukan Alamat" class="form-control">
                    
                    <div class=" col-sm-12 d-flex ">
                      {{-- daerah --}}
                      <div class="col-sm-5 mx-1">
                      <div id="emailHelp" class="form-text">Provinsi</div>
                      <select class="form-select" required name="provinsi" aria-label="Default select example" id="provinsi">
                      ...
                      <div class="col-sm-5 mx-1">
                        ...
                        <select class="form-select" name="kota" required aria-label="Default select example" id="kabupaten">
                          <option selected>Pilih</option>
                        ...
                        <div class="col-sm-5 mx-1">
                          ...
                          <select class="form-select" name="kecamatan" required aria-label="Default select example" id="kecamatan">
                            <option selected>Pilih</option>
                          ...
                          <div class="col-sm-5 mx-1">
                            ...
                            <select class="form-select" name="desa" required aria-label="Default select example" id="desa">
                              <option selected>Pilih</option>
