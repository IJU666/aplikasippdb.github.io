...
<div class="col-11 pt-3" >
    <nav>
        <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
          ...
          <a href="/ortu"  style="text-decoration: none;"><button class="nav-link col-auto active" >Orang Tua/Wali</button></a>
        ...
        <form action="/ortu" method="post">
          ...
          <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
            ...
            <div class="my-3 row">
              ...
              <div class="col-sm-6">
                <input type="number" class="form-control" required id="nikayah" name="nik_ayah" placeholder="Masukan NIK">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="namayah" required name="nama_ayah" placeholder="Masukan Nama Lengkap">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                <input type="date" class="form-control" id="tglahir" required name="tanggal_lahir_ayah" placeholder="Masukan Nama Lengkap">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-lg-7">
                ...
                <span class="input-group-text" id="basic-addon1">+</span>
                  <input type="number" class="form-control col-lg-7" id="hp" name="hp_ayah" required value="{{ old('hp_ayah') }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}" value="+62"  aria-label="Username" aria-describedby="basic-addon1" placeholder="contoh(+62 8928 23423 3231)">
          ...
          <div class="col-7 float-end">
            ...
            <div class="my-3 row">
              ...
              <div class="col-sm-6">
                <input type="number" class="form-control" id="nikibu" name="nik_ibu" required placeholder="Masukan NIK">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="namaibu" name="nama_ibu" required placeholder="Masukan Nama Lengkap">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                <input type="date" class="form-control" id="tglahiribu" name="tanggal_lahir_ibu" required placeholder="Masukan Nama Lengkap">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-lg-7">
                <div class="input-group">
                <span class="input-group-text" id="basic-addon1">+</span>
                  <input type="number" class="form-control col-lg-7" id="hp" name="hp_ibu" required value="{{ old('hp_ibu') }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}" value="+62"  aria-label="Username" aria-describedby="basic-addon1" placeholder="contoh(+62 8928 - 23423 - 3231)">
                {{-- <input type="number" class="form-control" id="hp" name="hp" required value="{{ old('hp') }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}" value="+62" placeholder="+62 Nomor (Whastapp)"> --}}
              </div>
            </div>
            </div>
