...
<div class="col-11 pt-3" >
  ...
  <nav>
    <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
      ...
      <a href="/jurusan"  style="text-decoration: none;"><button class="nav-link col-auto active" >Minat Jurusan</button></a>
...
<div class="tab-pane active show fade ms-4" id="nav-minjur" role="tabpanel" aria-labelledby="nav-minjur-tab">
    ...
    <div class="my-4">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-lg-5">
          <input type="text" name="hobi" id="hobi" placeholder="Masukan Hobi" class="form-control" required>
        </div>
      </div>
      <label for="disabilitas" class="mt-3 col-md-12 col-sm-12">Apakah anda sudah mengetahui tentang jurusan yang anda pilih?</label>
          ...
          <div class="form-check mx-3">
            <input class="form-check-input" type="radio" name="radio1" id="exampleRadios1" value="Ya" required >
            <label class="form-check-label" for="exampleRadios1">
              Ya
            </label>
          </div>
          <div class="form-check mx-4">
            <input class="form-check-input" type="radio" name="radio1" id="exampleRadios2" value="Tidak" required>
        ...
        <label for="disabilitas" class="mt-3">Apakah anda memiliki kemampuan yang dibutuhkan pada jurusan yang anda pilih?</label>
          <div class="d-flex mt-3 col-10">
          <div class="form-check mx-3">
            <input class="form-check-input" type="radio" name="radio2" id="exampleRadios1" value="Ya" required>
            <label class="form-check-label" for="exampleRadios1">
              Ya
            </label>
          </div>
          <div class="form-check mx-4">
            <input class="form-check-input" type="radio" name="radio2" id="exampleRadios2" value="Tidak" required>
            <label class="form-check-label" for="exampleRadios2">
              Tidak
            </label>
          </div>
        ...
        <div class="row mt-2">
          ...
          <div class="col-sm-9 mt-2 mb-1">
            <div class="form-floating">
              <textarea class="form-control" name="ketahui" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 150px" required></textarea>
          ...
          <div class="mb-1 row">
            ...
            <div class="col-sm-10 col-md-9">
              <select class="form-select" name="kemampuan" aria-label="Default select example" required>
