...
<div class="col-11 pt-3" >
    <nav>
        <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
          ...
          <a href="/asalsekolah"  style="text-decoration: none;"><button class="nav-link col-auto active" >Asal Sekolah</button></a>
 ...
 {{-- asal sekolah --}}
    <div class="tab-pane active show fade ms-4" id="nav-asalsekolah" role="tabpanel" aria-labelledby="nav-sekolah-tab">
      <form action="/asalsekolah" method="post">
        @csrf
      <div class="my-4">
        <div class="mb-3 row">
          <label for="npsn" class="col-sm-2 col-form-label">NPSN</label>
          <div class="col-sm-4">
            <input type="number" name="npsn" id="npsn" required placeholder="Masukan NPSN asal sekolah" class="form-control">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="sekolah" class="col-sm-2 col-form-label">Nama Sekolah</label>
          <div class="col-sm-5">
            <input type="text" name="nama_sekolah" required id="sekolah" placeholder="Masukan Nama Sekolah" class="form-control">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="sekolah" class="col-sm-2 col-form-label">Nomor Ijazah/SKL</label>
          <div class="col-sm-5">
            <input type="number" name="nomor_ijazah" id="sekolah" required placeholder="Masukan Nomor Ijazah" class="form-control">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="sekolah" class="col-sm-2 col-form-label">Alamat Sekolah</label>
          <div class="col-sm-5">
            <input type="text" name="alamat_sekolah" id="sekolah" required placeholder="Masukan Alamat Sekolah" class="form-control">
          
          <div class=" col-sm-12 d-flex ">
            {{-- daerah --}}
            <div class="col-sm-5 mx-1">
            <div id="emailHelp" class="form-text">Provinsi</div>
            <select class="form-select" id="provinsi" name="provinsi" required aria-label="Default select example">
            ...
            <div class="col-sm-5 mx-1">
              ...
              <select class="form-select" id="kabupaten" required name="kota" aria-label="Default select example">
                <option selected>Pilih</option>
              </select>
              </div>
              <div class="col-sm-5 mx-1">
                <div id="emailHelp" class="form-text">Kecamatan</div>
                <select class="form-select" id="kecamatan" required name="kecamatan" aria-label="Default select example">
                  <option selected>Pilih</option>
                </select>
                </div>
                <div class="col-sm-5 mx-1">
                  <div id="emailHelp" class="form-text">Desa</div>
                  <select class="form-select" id="desa" name="desa" required aria-label="Default select example">
                    <option selected>Pilih</option>
