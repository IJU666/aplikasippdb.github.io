  ...
  <div class=" tab-content col-lg-12" id="nav-tabContent">
    ...
    <div class="tab-pane active show fade ms-4" id="nav-ortu" role="tabpanel" aria-labelledby="nav-ortu-tab">
      <div class="mt-3">
        ...
        <form action="{{ url('update-ortu', $ortu->id) }}" method="post">
          @csrf
          <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
            <h4 id="scrollspyHeading1">Orang Tua Kandung</h4>
            <div class="d-flex border-bottom pb-2">
            <div class="col-7 ">
            <div class="mt-2">
              <h6>Identitas Ayah Kandung</h6>
            </div>
            <div class="my-3 row">
              <label for="nikayah" class="col-sm-4 col-form-label">NIK</label>
              <div class="col-sm-6">
                <input type="number" class="form-control" required id="nikayah" name="nik_ayah" value="{{ $ortu->nik_ayah }}" placeholder="Masukan NIK">
                <div id="nikayah" class="form-text">Diisi sesuai dengan KTP atau KK</div>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="namayah" class="col-sm-4 col-form-label">Nama</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="namayah" required name="nama_ayah" value="{{ $ortu->nama_ayah }}" placeholder="Masukan Nama Lengkap">
                <div id="namayah" class="form-text">Diisi sesuai dengan KTP atau KK</div>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="tglahir" class="col-sm-4 col-form-label">Tanggal Lahir</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="tglahir" required name="tanggal_lahir_ayah" value="{{ $ortu->tanggal_lahir_ayah }}" placeholder="Masukan Nama Lengkap">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="namayah" class="col-sm-4 col-form-label">Pendidikan Terakhir</label>
              <div class="col-sm-6">
                <select class="form-select" aria-label="Default select example" required name="pendidikan_ayah">
                  <option selected value="{{ $ortu->pendidikan_ayah }}" >{{ $ortu->pendidikan_ayah }}</option>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                {{-- <input type="text" class="form-control" id="pekerjaan" name="pekerjaan_ayah" placeholder="Masukan Nama Pekerjaan"> --}}
                <select class="form-select" aria-label="Default select example" required id="pekerjaan" name="pekerjaan_ayah">
                  <option selected value="{{ $ortu->pekerjaan_ayah }}" >{{ $ortu->pekerjaan_ayah }}</option>
            ...
            <div class="mb-3 row">
              <label for="no" class="col-sm-4 col-form-label">Nomor Ponsel</label>
              <div class="col-lg-7">
                <div class="input-group">
                <span class="input-group-text" id="basic-addon1">+</span>
                  <input type="number" class="form-control col-lg-7" id="hp" name="hp_ayah" required value="{{ $ortu->hp_ayah }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}"  aria-label="Username" aria-describedby="basic-addon1" placeholder="contoh(+62 8928 23423 3231)">
          ...
          <div class="col-7 float-end">
            <div class="mt-2">
              <h6>Identitas Ibu Kandung</h6>
            </div>
            <div class="my-3 row">
              <label for="nikibu" class="col-sm-4 col-form-label">NIK</label>
              <div class="col-sm-6">
                <input type="number" class="form-control" id="nikibu" name="nik_ibu" value="{{ $ortu->nik_ibu }}" required placeholder="Masukan NIK">
                <div id="nikibu" class="form-text">Diisi sesuai dengan KTP atau KK</div>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="namaibu" class="col-sm-4 col-form-label">Nama</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="namaibu" name="nama_ibu" required value="{{ $ortu->nama_ibu }}" placeholder="Masukan Nama Lengkap">
                <div id="namaibu" class="form-text">Diisi sesuai dengan KTP atau KK</div>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="tglahiribu" class="col-sm-4 col-form-label">Tanggal Lahir</label>
              <div class="col-sm-6">
                <input type="date" class="form-control" id="tglahiribu" name="tanggal_lahir_ibu" value="{{ $ortu->tanggal_lahir_ibu }}" required placeholder="Masukan Nama Lengkap">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="pendidikanibu" class="col-sm-4 col-form-label">Pendidikan Terakhir</label>
              <div class="col-sm-6">
                <select class="form-select" aria-label="Default select example" id="pendidikanibu" required name="pendidikan_ibu">
                  <option selected value="{{ $ortu->pendidikan_ibu }}" >{{ $ortu->pendidikan_ibu }}</option>
                  <option value="TAMAT SD/SEDERAJAT">Tamat SD/Sederajat</option>
                  <option value="TIDAK/BELUM SEKOLAH">Tidak/Belum Sekolah</option>
                  <option value="SLTA/SEDERAJAT">SLTA/Sederajat</option>
                  <option value="SLTP/SEDERAJAT">SLTP/Sederajat</option>
            ...
            <div class="mb-3 row">
              <label for="pekerjaanibu" class="col-sm-4 col-form-label">Pekerjaan</label>
              <div class="col-sm-6">
                {{-- <input type="text" class="form-control" id="pekerjaanibu" name="pekerjaan_ibu" placeholder="Masukan Nama Pekerjaan"> --}}
                <select class="form-select" aria-label="Default select example" id="pekerjaanibu" required name="pekerjaan_ibu">
                  <option selected value="{{ $ortu->pekerjaan_ibu }}" >{{ $ortu->pekerjaan_ibu }}</option>
                  <option value="Pegawai Negeri">Pegawai Negeri</option>
                  <option value="Pegawai Swasta">Pegawai Swasta</option>
                  <option value="Buruh">Buruh</option>
            ...
            <div class="mb-3 row">
              <label for="noibu" class="col-sm-4 col-form-label">Nomor Ponsel</label>
              <div class="col-lg-7">
                <div class="input-group">
                <span class="input-group-text" id="basic-addon1">+</span>
                  <input type="number" class="form-control col-lg-7" id="hp" name="hp_ibu" required value="{{ $ortu->hp_ibu }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}"  aria-label="Username" aria-describedby="basic-addon1" placeholder="contoh(+62 8928 - 23423 - 3231)">
                {{-- <input type="number" class="form-control" id="hp" name="hp" required value="{{ old('hp') }}" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}" value="+62" placeholder="+62 Nomor (Whastapp)"> --}}
              </div>
            </div>
            </div>
           ...
           <div class="col-sm-12 col-md-12 col-lg-12 mb-5 mt-3 ms-5">
