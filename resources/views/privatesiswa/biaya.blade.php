...
<div class="col-11 pt-3" >
    <nav>
      <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
        ...
        <a href="{{ url('edit-dokumen', $dokumen->id) }}"  style="text-decoration: none;"><button class="nav-link col-auto" >Dokumen Persyaratan</button></a>
        <a href="#"  style="text-decoration: none;"><button class="nav-link col-auto active" >Biaya Pendidikan</button></a>
      </div>
      </nav>
...
{{-- biaya --}}
<div class="tab-pane active show fade ms-4" id="nav-biaya" role="tabpanel" aria-labelledby="nav-biodata-tab">
    <div class="col-sm-10 mt-4">
      <h6 class="fw-normal">Apakah orang tua / wali anda bersedia memenuhi biaya selama masa pendidikan anda?</h6>        
    </div>
    <form action="/persyaratan" method="post">
      @csrf
    <div class="mt-4">
      <h6 class="fw-normal">Biaya SPP</h6>
      <div class="d-flex">
        <div class="form-check mx-1">
          <input class="form-check-input" type="radio" id="exampleRadios1" required value="Ya" name="spp">
          <label class="form-check-label" for="exampleRadios1">
            Ya
          </label>
        </div>
        <div class="form-check ms-4">
          <input class="form-check-input" type="radio" id="exampleRadios2" required value="Tidak" name="spp">
    ...
    <div class="mt-4">
      <h6 class="fw-normal">Biaya Seragam</h6>
      <div class="d-flex">
        <div class="form-check mx-1">
          <input class="form-check-input" type="radio" id="inlineRadio1" required value="Ya" name="seragam">
          <label class="form-check-label" for="inlineRadio1">Ya</label>
        </div>
        <div class="form-check ms-4">
          <input class="form-check-input" type="radio"  id="inlineRadio2" value="Tidak" name="seragam">
          <label class="form-check-label" for="inlineRadio2">Tidak</label>
        </div>
      </div>
    </div>
    <div class="mt-4">
      <h6 class="fw-normal">Biaya Bangunan</h6>
      <div class="d-flex">
        <div class="form-check mx-1">
          <input class="form-check-input" type="radio"  id="flexRadioDefault1" value="Ya" name="bangunan">
          <label class="form-check-label" for="flexRadioDefault1">
            Ya
          </label>
        </div>
        <div class="form-check ms-4">
          <input class="form-check-input" type="radio" id="flexRadioDefault2" value="Tidak" name="bangunan">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 mb-5 ms-5">
      <button type="submit" class="btn buttonoutline px-4 py-1 float-end px-4 py-1"  onclick="confirm('Simpan Data ini?')">Simpan</button>
    </div>
  </form>
  </div>
  {{-- akhir Biaya --}}
