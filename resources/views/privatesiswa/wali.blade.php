...
<div class="col-11 pt-3" >
    <nav>
        <div class="nav nav-tabs col-lg-12"  id="nav-tab" role="tablist">
          ...
          <a href="/dokumen"  style="text-decoration: none;"><button class="nav-link col-auto" >Dokumen Persyaratan</button></a>
          <a href="/persyaratan"  style="text-decoration: none;"><button class="nav-link col-auto" >Biaya Pendidikan</button></a>
        </div>
      </nav>
    ...
    <div class="tab-pane active show fade ms-4" id="nav-ortu" role="tabpanel" aria-labelledby="nav-ortu-tab">
        ...
        <div class="mt-3">
          ...
          <div class="my-3 row">
            ...
            <div class="col-sm-6">
              <input type="number" class="form-control" id="nikwali" required name="nik_wali" placeholder="Masukan NIK">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="namawali" name="nama_wali" required placeholder="Masukan Nama Lengkap">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-6">
              <input type="date" class="form-control" id="tglahirwali" name="tanggal_lahir_wali" required placeholder="Masukan Nama Lengkap">
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-lg-7">
              ...
              <span class="input-group-text" id="basic-addon1">+</span>
                <input type="number" class="form-control col-lg-7" id="hp" name="hp_wali" required value="62" pattern="+62 - [0-9]{3} - [0-9]{4} - [0-9]{3}"  aria-label="Username" aria-describedby="basic-addon1" placeholder="contoh(+62 8928 23423 3231)">
