...
<div class="tab-pane active show fade ms-4" id="nav-biaya" role="tabpanel" aria-labelledby="nav-biodata-tab">
    ...
    <div class="mt-4">
      ...
      <div class="d-flex">
        <div class="form-check mx-1">
          <input class="form-check-input" type="radio" id="inlineRadio1" value="Ya" required name="seragam">
          <label class="form-check-label" for="inlineRadio1">Ya</label>
        </div>
        <div class="form-check ms-4">
          <input class="form-check-input" type="radio"  id="inlineRadio2" value="Tidak" required name="seragam">
    ...
    <div class="mt-4">
      ...
      <div class="d-flex">
        <div class="form-check mx-1">
          <input class="form-check-input" type="radio"  id="flexRadioDefault1" value="Ya" required name="bangunan">
          <label class="form-check-label" for="flexRadioDefault1">
            Ya
          </label>
        </div>
        <div class="form-check ms-4">
          <input class="form-check-input" type="radio" id="flexRadioDefault2" value="Tidak" required name="bangunan">
